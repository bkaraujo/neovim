...
vim.cmd("set tabstop=2")        -- Show existing tab with 2 spaces width
vim.cmd("set softtabstop=2")    -- Show existing tab with 2 spaces width
vim.cmd("set shiftwidth=2")     -- When indenting with '>', use 2 spaces width
...
vim.cmd("set colorcolumn=122")  -- Draws a line at the given line to keep aware of the line size
...
vim.cmd("set guifont=JetBrainsMono-Regular:h16")
